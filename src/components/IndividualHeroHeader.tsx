import heroImage from "@/assets/hero-watching-individual.png";

export function IndividualHeroHeader() {
  return (
      ...
      <div className="container mx-auto px-4 pt-8">
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
          ...
          <div className="relative">
            <img
              src={heroImage}
              alt="Personaje viendo películas solo"
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-6 text-lg md:text-xl text-muted-foreground font-body flex items-center justify-center md:justify-start gap-2">
              ...
              Mis series y películas personales
              <span className="text-heart">📺</span>
            </p>
          </div>
        </div>
